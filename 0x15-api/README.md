...
### [0. Gather data from an API](https://github.com/vpnchengo/alx-system_engineering-devops/blob/master/0x15-api/0-gather_data_from_an_API.py)
...
```
### [1. Export to CSV](https://github.com/vpnchengo/alx-system_engineering-devops/blob/master/0x15-api/1-export_to_CSV.py)
...
### [2. Export to JSON](https://github.com/vpnchengo/alx-system_engineering-devops/blob/master/0x15-api/2-export_to_JSON.py)
...
```
### [3. Dictionary of list of dictionaries](https://github.com/vpnchengo/alx-system_engineering-devops/blob/master/0x15-api/3-dictionary_of_list_of_dictionaries.py)
